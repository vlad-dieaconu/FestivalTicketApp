...
public class UserServiceTest {
    ...
    public void testAddOneUser() throws Exception {
        UserService.loadUsersFromFile();
        UserService.addUser("test0", "testPass0", "test@email.com","20");
        assertNotNull(UserService.users);
    ...
    public void testAddTwoUsers() throws Exception {
        UserService.loadUsersFromFile();
        UserService.addUser("test1", "testPass1", "test1@email.com","30");
        UserService.addUser("test2", "testPass2", "test2@email.com","40");
        assertNotNull(UserService.users);
    ...
    public void testAddUserAlreadyExists() throws Exception {
        UserService.loadUsersFromFile();
        UserService.addUser("test1", "testPass3", "test@mail.com","20");
        assertNotNull(UserService.users);
    ...
    public void testAddOneUserIsPersisted() throws Exception {
        UserService.loadUsersFromFile();
        UserService.addUser("test9", "testPass9", "123@email.com","30");
    ...
    public void testAddTwoUserArePersisted() throws Exception {
        UserService.loadUsersFromFile();
        UserService.addUser("test11", "testPass11", "email1@gmail.com","30");
        UserService.addUser("test122", "testPass12", "email2@gmail.com","24");
        List<User> users = new ObjectMapper().readValue(UserService.USERS_PATH.toFile(), new TypeReference<List<User>>() {
        });
        assertNotNull(users);
